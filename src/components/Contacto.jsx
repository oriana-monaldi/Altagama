...
import SocialIcons from './SocialIcons'; // Asegúrate de que la ruta sea correcta

const Contacto = () => {
  return (
    <div id="contacto" className="bg-cover bg-center py-16" style={{ backgroundImage: 'url(../img/car4.jpg)' }}>
