        ...
        <StyledWrapper>
          <ul className="wrapper">
            <li className="icon facebook">
              ...
              <a href="https://www.facebook.com/AltaGamaBCS/?locale=es_LA" target="_blank" rel="noopener noreferrer">
                <svg
                  viewBox="0 0 320 512"
                  height="1.2em"
                  fill="currentColor"
            ...
            <li className="icon instagram">
              ...
              <a href="https://www.instagram.com/taller.altagama/" target="_blank" rel="noopener noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1.2em"
                  fill="currentColor"
